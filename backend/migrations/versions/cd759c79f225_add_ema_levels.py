...
def upgrade() -> None:
    """Upgrade schema."""
    op.add_column(
        "technical_signals", sa.Column("ema5_level", sa.Float(), nullable=True)
    )
    op.add_column(
        "technical_signals", sa.Column("ema13_level", sa.Float(), nullable=True)
    )
    op.add_column(
        "technical_signals", sa.Column("ema20_level", sa.Float(), nullable=True)
    )
    op.add_column(
