...
def test_get_stock_detail_success():
    ...
    try:
        # Clean up if exists
        db.query(Stock).filter(Stock.symbol == "TEST_RELIANCE").delete()
        db.query(TechnicalSignal).filter(TechnicalSignal.symbol == "TEST_RELIANCE").delete()
        db.query(FundamentalData).filter(FundamentalData.symbol == "TEST_RELIANCE").delete()
        db.query(FundamentalCache).filter(FundamentalCache.symbol == "TEST_RELIANCE").delete()
