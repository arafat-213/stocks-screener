import pytest
import pandas as pd
from app.backtest.engine import compute_metrics, BacktestConfig
...
def test_compute_metrics_empty_trades_returns_all_keys():
    ...
    expected_keys = [
        "total_trades", "winning_trades", "win_rate", "avg_return_pct",
        "median_return_pct", "best_trade_pct", "worst_trade_pct",
        "max_drawdown_pct", "sharpe_ratio", "total_return_pct",
        "gross_return_pct", "total_cost_drag_pct", "benchmark_return_pct",
        "equity_curve", "expectancy", "profit_factor", "avg_win_pct",
        "avg_loss_pct", "exit_breakdown"
    ]
