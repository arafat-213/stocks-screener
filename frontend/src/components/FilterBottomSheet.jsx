    ...
    <div className='fixed inset-0 z-[1000] flex items-end justify-center sm:items-center p-0 sm:p-4'>
      ...
      <div className='relative w-full max-w-[500px] bg-bg-secondary rounded-t-[32px] sm:rounded-3xl shadow-2xl p-8 animate-fade-in border-t sm:border-2 border-border flex flex-col gap-8'>
        <header className='flex justify-between items-center'>
          ...
          <button
            className='bg-slate-100 dark:bg-slate-800 p-2 rounded-full border-none cursor-pointer text-slate-500 hover:text-text transition-colors'
            onClick={onClose}
          >
            <X size={24} />
          </button>
        ...
        <div className='flex gap-3 pt-4 border-t border-border mt-auto'>
          <button
            className='bg-slate-100 dark:bg-slate-800 text-text border-none p-4 rounded-2xl font-black uppercase tracking-widest text-[10px] cursor-pointer transition-all hover:bg-slate-200 dark:hover:bg-slate-700 flex items-center justify-center gap-2'
            onClick={resetFilters}
          >
            <RotateCcw size={16} /> Reset
          </button>
          <button
            className='flex-1 bg-blue-600 text-white border-none p-4 rounded-2xl font-black uppercase tracking-widest text-[10px] cursor-pointer transition-all hover:bg-blue-700 shadow-lg shadow-blue-500/20'
            onClick={onClose}
          >
            Apply Analysis
          </button>
