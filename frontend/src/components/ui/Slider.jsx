      ...
      <div className={`w-full relative pb-4 ${className}`}>
        {label && (
          <div className='flex justify-between items-center mb-4'>
            <label className='text-[10px] font-black uppercase text-slate-500 dark:text-slate-400 tracking-[0.2em]'>
              {label}
            </label>
            <span className='text-sm font-black text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/30 px-3 py-1 rounded-lg font-mono shadow-sm border border-blue-100 dark:border-blue-900/50'>
              {value}
            </span>
          </div>
        )}
