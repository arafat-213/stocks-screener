  ...
  const digestColumns = useMemo(
    () => [
      ...
      },
      {
        ...
        render: (val) => (
          <span
            className={`px-2 py-0.5 rounded text-[10px] font-black uppercase ${val === 1 ? 'bg-bullish text-white' : 'bg-blue-500 text-white'}`}
          >
            Tier {val}
          </span>
        ),
      ...
      },
      {
        ...
        label: 'Stop Loss',
        render: (val) => (
          <span className='text-[10px] font-black text-bearish'>
            ₹{val?.toFixed(2)}
          </span>
        ),
      },
          ...
          <div className='bg-bg-secondary border-2 border-border rounded-3xl overflow-hidden shadow-sm'>
            <div className='px-8 py-6 border-b-2 border-border flex justify-between items-center bg-blue-600 text-white'>
              <div className='flex items-center gap-4'>
                ...
                <div>
                  <h2 className='m-0 text-xl font-black uppercase tracking-tight'>
                    Today's High Conviction Digest
                  </h2>
                  <p className='m-0 text-[10px] font-bold text-white/70 uppercase tracking-widest mt-1'>
                    Surgical entry zones for session: {digestData?.date}
                  </p>
                </div>
              </div>
              <div className='flex gap-3'>
                ...
                <span
                  className={`text-[10px] font-black py-1.5 px-4 rounded-full uppercase tracking-[0.15em] border ${digestData?.regime_bullish ? 'bg-green-500 border-green-400' : 'bg-red-500 border-red-400'}`}
                >
              ...
              <div className='bg-bg-secondary border-2 border-border rounded-3xl shadow-sm overflow-hidden animate-fade-in'>
                <div className='px-8 py-6 border-b-2 border-border flex justify-between items-center bg-slate-50 dark:bg-slate-900/50'>
                  <div className='flex items-center gap-4'>
                    ...
                    <h3 className='m-0 text-xl font-black uppercase tracking-tight tracking-tight'>
